...
- (void)setupStyleSheet {
    ...
    CGFloat contentViewHeight = rowHeight * 5 + headerViewHeight + 20;
...
- (void)setIsWeekMode:(BOOL)isWeekMode {
    ...
    _headerView.isWeekMode = isWeekMode;
}

#pragma Getter

- (UIButton *)beginBtn {
    return self.headerView.beginBtn;
}

- (UIButton *)endBtn {
    return self.headerView.endBtn;
}
