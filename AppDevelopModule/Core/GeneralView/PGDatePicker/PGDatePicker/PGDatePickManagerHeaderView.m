...
- (void)setyleWeek {
    ...
    self.lineView.frame = CGRectMake(0,
                                     ...
                                     self.bounds.size.width,
                                     lineViewHeight);
    self.middleLineView.frame = CGRectMake(0,
                                    100-lineViewHeight,
                                    self.bounds.size.width,
                                    lineViewHeight);
    self.titleLabel.frame = CGRectMake((self.bounds.size.width - self.titleLabelSize.width) / 2,
    ...
    UILabel *zhiL = [UILabel new];
    zhiL.frame = CGRectMake((self.bounds.size.width-20)/2, 65, 20, 20);
    zhiL.text = @"至";
    zhiL.font = [UIFont systemFontOfSize:16];
    zhiL.textColor = [UIColor pg_colorWithHexString:@"##999999"];
    [self addSubview:zhiL];
    
    self.beginBtn.frame = CGRectMake(0, 50, (self.bounds.size.width-20)/2, 50);
    self.endBtn.frame = CGRectMake((self.bounds.size.width-20)/2+20, 50, (self.bounds.size.width-20)/2, 50);
...
- (UIButton *)beginBtn {
    if (!_beginBtn) {
        ...
        _beginBtn.titleLabel.font = [UIFont systemFontOfSize:17];
        [_beginBtn setTitleColor:[UIColor pg_colorWithHexString:@"#999999"] forState:UIControlStateNormal];
        [_beginBtn setTitleColor:[UIColor pg_colorWithHexString:@"#FD2D3C"] forState:UIControlStateSelected];
...
- (UIButton *)endBtn {
    if (!_endBtn) {
        ...
        _endBtn.titleLabel.font = [UIFont systemFontOfSize:17];
        [_endBtn setTitleColor:[UIColor pg_colorWithHexString:@"#999999"] forState:UIControlStateNormal];
        [_endBtn setTitleColor:[UIColor pg_colorWithHexString:@"#FD2D3C"] forState:UIControlStateSelected];
...
- (UIView *)lineView {
    if (!_lineView) {
        ...
        view.backgroundColor = [UIColor pg_colorWithHexString:@"#D8D8D8"];
