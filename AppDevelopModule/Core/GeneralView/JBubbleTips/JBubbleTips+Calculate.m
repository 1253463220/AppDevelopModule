...
- (CGSize)bubbleSizeWithTargetPoint:(CGPoint)targetPoint inContainerView:(UIView *)containerView {
    ...
    switch (self.style) {
        case JBubbleTipsStyleText:{
            ...
            switch (self.direction) {
                case JBubbleTipsDirectionUp:{
                    maxContentWidth = containerView.jb_width - 2 * self.slidePadding - self.bubbleContentInsets.left - self.bubbleContentInsets.right;
                    maxContentHeight = containerView.jb_height - targetPoint.y - self.pointerSize - self.pointerMargin - self.bubbleContentInsets.top - self.bubbleContentInsets.bottom;
                }
                    break;
                case JBubbleTipsDirectionDown: {
                    maxContentWidth = containerView.jb_width - 2 *self.slidePadding - self.bubbleContentInsets.left - self.bubbleContentInsets.right;
                    ...
                    break;
                case JBubbleTipsDirectionLeft: {
                    maxContentWidth = containerView.jb_width - targetPoint.x - self.slidePadding - self.pointerSize - self.pointerMargin - self.bubbleContentInsets.left - self.bubbleContentInsets.right;
                    maxContentHeight = containerView.jb_height - 2 * self.slidePadding - self.bubbleContentInsets.top - self.bubbleContentInsets.bottom;
                }
                    break;
                case JBubbleTipsDirectionRight: {
        ...
        case JBubbleTipsStyleCustom:
            if (self.customView && self.customView.jb_width != 0 && self.customView.jb_height != 0) {
                CGFloat width = self.customView.jb_width + self.bubbleContentInsets.left + self.bubbleContentInsets.right;
                CGFloat height = self.customView.jb_height + self.bubbleContentInsets.top + self.bubbleContentInsets.bottom;
...
- (CGRect)bubbleFrameWithTargetPoint:(CGPoint)targetPoint inContainerView:(UIView *)containerView {
    ...
    switch (self.direction) {
        ...
        case JBubbleTipsDirectionDown:{
            ...
            if (x_begin + self.bubbleSize.width + self.slidePadding > containerView.jb_width) {
                x_begin = containerView.jb_width - self.bubbleSize.width - self.slidePadding;
            }
        ...
        case JBubbleTipsDirectionRight: {
            ...
            if (y_begin + self.bubbleSize.height + self.slidePadding > containerView.jb_height) {
                y_begin = containerView.jb_height - self.slidePadding - self.bubbleSize.height;
            }
