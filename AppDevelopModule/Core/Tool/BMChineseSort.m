...
+ (NSString *)transformToPinyin:(NSString *)word {
    NSMutableString *mutableString = [NSMutableString stringWithString:word];
    CFStringTransform((CFMutableStringRef)mutableString, NULL, kCFStringTransformToLatin, false);
    NSString *pinyinString = (NSMutableString *)[mutableString stringByFoldingWithOptions:NSDiacriticInsensitiveSearch locale:[NSLocale currentLocale]];  // 转换拼音
    NSString *strUrl = [pinyinString stringByReplacingOccurrencesOfString:@" " withString:@""]; // 删除空格
